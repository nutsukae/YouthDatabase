    ...
    Private Sub List(ByVal StartDate As String, ByVal StopDate As String)
        ...
        If Not ds Is Nothing Then
            ...
            For Each row As DataRow In ds.Tables(0).Rows
                ...
                dgvYouthList.Rows.Add(dgvYouthList.Rows.Count + 1, fullname, idcard, caseno, blackno, redno, title, name)
            Next
        End If

        Dim sfd = New SaveFileDialog()
        sfd.Filter = "Excel Documents (*.xls)|*.xls"
        sfd.FileName = "รายชื่อเด็กและเยาวชนที่กระทำความผิดซ้ำ.xls"
